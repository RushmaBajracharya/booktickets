             ...
             AppLayoutBuilderWidget(sections: 12,isColor: false,),
              ...
              Row(
                ...
                children: [
                  ...
                  AppColumnLayout(firstText: "McDonal", secondText:"Received form", alignment: CrossAxisAlignment.end,isColor: false,)
                ],
              ),
              Gap(AppLayout.getHeight(12)),
              AppLayoutBuilderWidget(sections: 12,isColor: false,),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  AppColumnLayout(firstText: "28 344", secondText:"Miles", alignment: CrossAxisAlignment.start,isColor: false,),
                  AppColumnLayout(firstText: "Destech", secondText:"Received form", alignment: CrossAxisAlignment.end,isColor: false,)
                ],
              )
            ],
          ),
